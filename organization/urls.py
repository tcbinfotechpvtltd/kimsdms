...
from .views import DepartmentListView, DocumentCreateAPI, DocumentDeleteAPI, RecordCreateView, RecordListView, RolesListCreateAPIView, RolesRetrieveUpdateDestroyAPIView, SapRecordCreateView
